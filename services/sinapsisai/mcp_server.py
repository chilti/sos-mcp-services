...
from services.sinapsisai.tools.graph_tools import query_knowledge_graph_cypher, search_scientific_papers_semantic, get_entity_statistics, query_duckdb_analytics
...
# Registro de Herramientas 6.1 - 6.6
...
mcp.tool()(query_duckdb_analytics)
